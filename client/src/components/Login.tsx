                ...
                <div className="absolute top-0 p-8 flex justify-between w-full items-center z-10"> 
                    ...
                    <Link to="/registartion">
                        <button
                            ...
                            className="border-2 bg-neutral text-secondary p-2 text-indigo-900 hover:bg-purple-300 hover:text-purple-900 rounded transition duration-500 ease-in-out font-medium cursor-pointer"
                        >
                            Registration 
                        </button>
                    </Link>
