...
const Footer = () => {
    return (
      <footer className="bg-primary text-white pt-12 pb-8 px-4">
        <div className="mx-auto px-4 container overflow-hidden flex flex-col lg:flex-row justify-between">
          {/* Logo Section */}
          <a href="/" className="block mb-6 lg:mb-0 w-full lg:w-1/3">
            <img
              src={logo}
              className="w-24 mx-auto lg:ml-0"
              alt="logo"
            />
          </a>
  
          {/* Links Sections (Product, Company, Developers) */}
          <div className="w-full lg:w-2/3 flex flex-col lg:flex-row justify-between">
            {/* Product Links */}
            <ul className="text-gray-700 list-none p-0 font-thin flex flex-col lg:w-1/3">
        ...
        {/* Follow Us Section */}
        <div className="text-gray-700 flex flex-col w-full mt-6">
